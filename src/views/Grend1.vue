<<<<<<< HEAD
<template class=""> <div class="grend1 ">
...
<template class="">
    <div class="grend1 ">
        ...
        <section class="parent">
            <p class="child1"><span class="blue">DU</span> hast <span class="blue">Bruder<br> Fritschi</span> gewählt
            </p>
            <img src="../assets/BruderFritschi.svg" class="child2">
            <h4 class="child3 blue">Bru<br>der <br>Frit<br>schi</h4>
            <span class="child4">
                <h5 class="para-title">Gute Wahl</h5>
                <p class="para-text"> Unübersehbar. Mit ehrfurchtgebietender gefurchter Holzmaske, langem Bart und im
                    blauweissen Luzerner Staatsmantel. Einige sehen in ihm die mythische Symbolfigur eines heidnischen
                    Fruchtbarkeitskults. Wahrscheinlicher ist, dass sein Vorbild ein «trinkfreudiger» Luzerner
                    Landsknecht namens Fridolin (Friedrich, Fritschi) ist, der in der Schlacht von Ragaz 1446 am 6. März
                    (Fridolinstag) beim Sieg der Eidgenossen über die Österreicher mitkämpfte.
                    Heute eröffnet er mit der Fritschifamilie am Schmudo die Fasnacht. Folge ihm. Er wird dir Orte
                    zeigen, die du noch nicht kennst. </p>
            </span>
        </section>
        ...
        <section class="tagwach parent2">
            ...
            <h6 class="child7">Kapellplatz, SchmuDO 5:00 Uhr</h6>
            <div class="wrapper-video yellowbg child6">
                <video class="tagwach_video">
                    <source
                        src="/Users/michellespengler/Desktop/HSLU/3. Semester/Web und Mobile/fasnacht/src/assets/Bruele.mp4">
                    </video>
            </div>
            <!--------------------- videos gehen nicht --------------------->
            <video class="tagwach_video" controls>
            ...
            <p class="child12">1-0-0- t-a-u-s-e-n-d-e- P-a-p-i-e-r- s-c-h-n-i-t-z-e-l z-e-r-s-c-h-n-i-t-t-e-n-e
                T-e-l-e-f-o-n-b-ü-c-h-e-r-n-
...
>>>>>>> a8c41dbafd31fa3c0ad1e2b0933e31927d6a30b2
</template>
