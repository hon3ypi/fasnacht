<template class="">
    <div class="grend1 ">
        ...
        <section class="fritschi parent">
            ...
            <span class="child4">
                <h5>Gute Wahl</h5>
                <p class=""> Unübersehbar. Mit ehrfurchtgebietender gefurchter Holzmaske, langem Bart und im blauweissen
                    Luzerner Staatsmantel. Einige sehen in ihm die mythische Symbolfigur eines heidnischen
        ...
        <section class="tagwach parent2">
            ...
            <div class="wrapper-video yellowbg child6">
                ...
                <video src="assets/Bruele.mp4" class="video_tagwach"></video>
